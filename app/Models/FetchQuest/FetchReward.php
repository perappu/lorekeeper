...
class FetchReward extends Model
{
    /**
     ...
     */
    protected $fillable = [
        'fetch_quest_id', 'rewardable_type', 'rewardable_id', 'quantity'
    ];
    ...
    **********************************************************************************************/
    ...
    /**
     * Get the reward attached to the fetch reward.
     */
